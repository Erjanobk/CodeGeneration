...
@RestController
public class CloseAccountsApiController implements CloseAccountsApi {

    private static final Logger log = LoggerFactory.getLogger(CloseAccountsApiController.class);
    ...
    public CloseAccountsApiController(ObjectMapper objectMapper, HttpServletRequest request) {
