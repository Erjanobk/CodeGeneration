...
public interface CreateTransactionApi {
    ...
    @Operation(summary = "The user will be able to transfer funds", description = "", tags={ "transaction" })
    @ApiResponses(value = { 
    ...
    ResponseEntity<List<TransactionResult>> createTransaction(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody Transactions body);
